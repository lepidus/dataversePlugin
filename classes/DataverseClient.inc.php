...
class DataverseClient {
    ...
    public function depositAtomEntry($atomEntryPath, $submissionId) {
        $depositReceipt = $this->swordClient->depositAtomEntry($this->dataverseUri, $this->apiToken, '', '', $atomEntryPath);
    ...
    public function depositFiles($editMediaUri, $packageFilePath, $packaging, $contentType) {
        $depositReceipt = $this->swordClient->deposit($editMediaUri, $this->apiToken, '', '', $packageFilePath, $packaging, $contentType, false);
    ...
    public function retrieveDepositReceipt($request) {
        $depositReceipt = $this->swordClient->retrieveDepositReceipt($request, $this->apiToken, '', '');
    ...
    public function completeIncompleteDeposit($request) {		
        $response = $this->swordClient->completeIncompleteDeposit($request, $this->apiToken, '', '');
